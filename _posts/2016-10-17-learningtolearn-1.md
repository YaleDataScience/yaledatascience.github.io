...
by [Yutaro Yamada](http://runopti.github.io/blog/)
...
Let's say the objective funtion is $$f(\theta) = \lVert W \theta - y \rVert^2$$, where the elements of $$W$$ and $$y$$ are drawn from the Gaussian distribution.
